    ...
    let spotItem = `
      <div class="col-md-4 mb-5">
        <a class="spotListItem card h-100" href="#">
          <div class="spotRegionTag">${filterArea.area}</div>
          <img src="${filterArea.imgUrl}" class="card-img-top" alt="...">
          <div class="card-body mb-3">
            <div class="spotReginStar bgPrimary">${filterArea.rate}</div>
            <h5 class="spotTitle card-title">${filterArea.name}</h5>
            <p class="spotDescribe card-text">${filterArea.description}</p>
          </div>
          <div class="card-footer textPrimary d-flex justify-content-between align-items-center">
            <p class="">
              <i class="fas fa-exclamation-circle"></i>
              剩下最後 ${filterArea.group} 組
            </p>
            <p class="d-flex align-items-center">TWD<span class="fontSizeL">${filterArea.price}</span></p>
          </div>
        </a>
      </div>
    `;
          ...
          <a class="spotListItem card h-100" href="#">
            <div class="spotRegionTag">${item.area}</div>
              ...
              <div class="card-footer textPrimary d-flex justify-content-between align-items-center">
                ...
                <p class="d-flex align-items-center">TWD<span class="fontSizeL">${item.price}</span></p>
              </div>
            </a>
          </div>
        `;
